<template>
                    ...
                    >
                      <div class="text-center">
                        ...
                        <div class="border-2 border-primary border-dashed rounded-lg p-4 mb-4">
                          ...
                          >
                            <i class="pi pi-qrcode text-5xl text-primary mb-2"></i>
                            <p class="text-gray-500">Đang chờ quét mã QR...</p>
                          </div>
                ...
                >
                  ...
                  <div class="grid gap-4">
                    ...
                    <div class="col-12 md:col-8 space-y-2">
                      <label class="block font-medium text-gray-700"> Loại địa chỉ </label>
                      <InputText
                    ...
                    <div class="col-12 md:col-4 flex items-center justify-end">
                      <div class="flex items-center space-x-2">
                        ...
                        />
                        <label for="defaultAddress" class="text-gray-700"> Địa chỉ mặc định </label>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    if (isEditMode.value) {
      try {
        ...
        form.value = {
          ...
          diaChis: staffData.diaChis?.length > 0 ? staffData.diaChis.map(addr => ({
            ...addr,
  ...
  // Mock QR scan function - trong thực tế sẽ tích hợp với thư viện quét QR
  const scanQRCode = () => {
    // Giả lập quét QR thành công sau 2 giây
    setTimeout(() => {
      qrScanResult.value = '079123456789' // Mock QR result
    }, 2000)
  }

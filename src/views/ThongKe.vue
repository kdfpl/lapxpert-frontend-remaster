...
// import TableAdv from "./TableAdv.vue";
...
<template>
  <div>
    <div class="flex flex-row justify-center mb-3">
      ...
      <!-- <div class="  card rounded border-white p-5 flex flex basis-1/4 mr-3">
        <div class="basis-64">
          <div class="text-2xl text-[#8B658B] font-bold">
            231
          </div>
      ...
      <div class=" card rounded border-white p-5 flex flex basis-1/4 mr-3">
        <div class=" basis-64">
          <div class="text-2xl text-[#CD5555] font-bold">
              328
          </div>
          <div class="text-sm mb-10">Doanh Số</div>
          <div class="flex flex">
        ...
        <div class=" mt-4 w-[90px]">
          <img src="/src/assets/img/money.png" alt="" />
        </div>
      </div>

      <div class=" card rounded border-white p-5 flex flex basis-1/4 mr-3">
        <div class=" basis-64">
          <div class="text-2xl text-[#FF1493] font-bold">
            6
            </div>
      ...
      <div
        class="    card rounded border-white p-5 flex flex basis-1/4 ">
        <div class=" basis-64">
          <div class="text-2xl text-[#CD9B1D] font-bold">136.000.000đ</div>
          <div class="text-sm mb-10">Thu nhập</div>
          <div class="flex flex">
            <div class="text-xs mr-2 text-[#7A8B8B]">
              <a href="">See more...</a>
            </div>
        ...
        <div class=" mt-4 w-[90px]">
          <img
            src="/src/assets/img/give-money.png"
            alt="" />
        </div>
      </div> -->
    </div>
    <div class="flex flex-row mb-3">
      <div class="card p-8 basis-2/3 mr-3">
        <div class="flex flex-row">
          <h4 class="mt-2 ml-2">Đơn hàng gần đây</h4>
        </div>
      ...
      <div
        ref="containerRef"
        class="card flex flex-col p-8 transition-all duration-300 overflow-hidden"
        :class="isScrollbarVisible ? 'basis-2/3' : 'basis-1/3'"
      >
        <!-- <BestSellingWidget/> -->

        <h5 class="mb-12">Top Sản phẩm bán chạy hiện nay </h5>
        <div class="flex justify-center mb-6 text-[#FFFFFF]">
          <button @click="selectedTop = 'TopNgay'" class="px-3 py-2 rounded-l-lg bg-gray-400">
            Day
          </button>
          <button @click="selectedTop = 'TopTuan'" class="px-3 py-2 bg-gray-400"> Week </button>
    ...
    <div class="flex flex-row">
      <div class="card basis-1/3 p-8 mr-3">
        <NotificationsWidget />
      </div>
      <div
        ref="containerRef"
      ...
      >
        ...
        <div class="flex justify-center text-[#FFFFFF]">
          ...
          <button @click="selectedDoanhThu = 'Month'" class="px-3 py-2 bg-gray-400"> Month </button>

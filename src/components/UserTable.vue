          ...
          <div class="flex justify-between align-items-center gap-2">
            <div class="flex">
              ...
              <div class="flex gap-2">
                <Button text icon="pi pi-plus" label="Mở rộng tất cả" severity="contrast" @click="expandAll" />
                <Button text icon="pi pi-minus" label="Thu gọn tất cả" severity="contrast" @click="collapseAll" />
              </div>
            </div>
